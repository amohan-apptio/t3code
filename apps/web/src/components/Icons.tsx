...
export const BobIcon: Icon = (props) => {
  const id = useId().replaceAll(":", "");
  const shadowGradientId = `${id}-bob-shadow`;
  const bodyGradientId = `${id}-bob-body`;
  const maskId = `${id}-bob-mask`;
  ...
  return (
    <svg {...props} viewBox="0 0 32 32">
      <defs>
        ...
        <mask id={maskId} width="32" height="32" x="0" y="0" maskUnits="userSpaceOnUse">
          <path
            ...
            fill="#fff"
          />
          <path d="M21 7v7H11V7h10z" fill={`url(#${shadowGradientId})`} />
        </mask>
      </defs>
      <g mask={`url(#${maskId})`}>
        <path d="M0 0h32v32H0z" fill={`url(#${bodyGradientId})`} />
      </g>
      <path
